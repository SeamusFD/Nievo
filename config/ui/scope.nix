  ...
  plugins.lazy.plugins = with pkgs.vimPlugins; [
    {
      ...
      config = ''
        function()
           ...
           keymap("n", "<leader>vgh", "<cmd>Lspsaga lsp_finder<CR>", {silent = true, desc = "Lsp Finder"})
           ...
           keymap("n", "<leader>vl", "<cmd>Lspsaga show_line_diagnostics<CR>", {silent = true, desc = "Show line diagnostics"})

           -- Show cursor diagnostics
           keymap("n", "<leader>vc", "<cmd>Lspsaga show_cursor_diagnostics<CR>", {silent = true, desc = "Show cursor diagnostic"})

           -- Show buffer diagnostics
           keymap("n", "<leader>vb", "<cmd>Lspsaga show_buf_diagnostics<CR>", {silent = true, desc = "Show buffer diagnostic"})
           ...
           -- Toggle outline
           keymap("n", "vs", "<cmd>Lspsaga outline<CR>", {silent = true, desc = "Toggle outline"})
           ...
           -- Float terminal
           keymap("n", "<A-t>", "<cmd>Lspsaga term_toggle<CR>", {silent = true, desc = "Float terminal"})
           keymap("t", "<A-t>", "<cmd>Lspsaga term_toggle<CR>", {silent = true, desc = "Float terminal"})
        end
      '';
    }
    {
